...
class SPServicesFragment(var status: String) : Fragment() {
    ...
    private fun setupAdapter() {
        ...
        binding.rv.adapter=SPServiceAdapter(this.requireContext(),list,if(status==ServiceRequest.REJECTED.name){
            View.VISIBLE
        }else{
            View.GONE
        }){
